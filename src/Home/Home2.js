    ...
    <div className="containerhome">
      <div className="headerhome">
        ...
        <div className="headerbutton">
          <a href="/sign-up" className="headerbutton2">Sign Up<br/>To Register</a>
        </div>
      ...
      <div className="Navbarhome">
        ...
        <HashLink smooth to="#Aboutus" className="link1home">About Us</HashLink>
        <HashLink smooth to="#footerHome1" className="link2home">Contacts</HashLink>
        {/* <Link to="#" className="link3home">Contacts</Link> */}
      ...
      <div className = "footerHome1" id = "footerHome1">
